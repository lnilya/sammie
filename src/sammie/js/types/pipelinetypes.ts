...
export type PipelineOutput = {
     ...
     * you want to create multiple outputs from a single key by a single module and in that case you can pass
     * exporterParams to identify what kind of output is generated. (For example export something as CSV data and additionally as bar graph image) */
    exporterParams?:Record<string, any>
